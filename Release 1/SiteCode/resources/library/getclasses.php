...
$classessql = "Select CONCAT(ta.FirstName, ' ', ta.LastName) AS TeacherName, i.Name As Instrument, p.Name As Proficiency, c.NumOfStudents, c.Description, c.StartDate, c.Day, c.EndDate, c.Time, c.SessionLength, c.Cost
From class c
...
foreach ($rows as $row) {
  ...
  echo '<td id="NumOfStudents">'.$row['NumOfStudents'].'</td>';
